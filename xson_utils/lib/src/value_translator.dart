...
void registerPrimitiveTranslatorT<T, R>(TypeTranslator<T, R> translator) {
  print("register primitive translator $T -> $R");
...
//    print("translator group<$outputType> add<$T> new translator");
...
//    print("translator group<$outputType> add<$inputType> new translator");
