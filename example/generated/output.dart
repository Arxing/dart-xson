...
class OutputList$0ListThreeBean {
  ...
  factory OutputList$0ListThreeBean.fromJson(dynamic json) {
    ...
    if (json is List)
      return _$OutputList$0ListThreeBeanFromJson({'data': json});
    throw 'fromJson parameter must be List or Map, but you give ${json?.runtimeType}';
  }
...
class OutputList$0ListFa$0ListBean {
  ...
  int day;
  @JsonKey(
      fromJson: _parserFuncList$0ListFa$0ListTeamAName, name: "team_a_name")
  String teamAName;
  @JsonKey(
      fromJson: _parserFuncList$0ListFa$0ListTeamBName, name: "team_b_name")
  String teamBName;
  ...
  factory OutputList$0ListFa$0ListBean.fromJson(dynamic json) {
    ...
    if (json is List)
      return _$OutputList$0ListFa$0ListBeanFromJson({'data': json});
    throw 'fromJson parameter must be List or Map, but you give ${json?.runtimeType}';
  }
...
dynamic _innerValueParser(dynamic v) {
  if (v == null) return null;
  Type type = v.runtimeType;
  if (isPrimitive(type)) return JsonValueTransformer.parse(v);
  if (isList(type))
    return (v as List).map((element) => _innerValueParser(element)).toList();
  if (type == OutputBean) return OutputBean.fromJson(v);
  if (type == OutputList$0ListBean) return OutputList$0ListBean.fromJson(v);
  if (type == OutputList$0ListFa$0ListBean)
    return OutputList$0ListFa$0ListBean.fromJson(v);
  if (type == OutputList$0ListThreeBean)
    return OutputList$0ListThreeBean.fromJson(v);
  if (type == OutputList$0ListFiveBean)
    return OutputList$0ListFiveBean.fromJson(v);
}

int _parserFuncRes(dynamic v) => JsonValueTransformer.parse<int>(v);

String _parserFuncList$0ListOrderId(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

int _parserFuncList$0ListItemid(dynamic v) =>
    JsonValueTransformer.parse<int>(v);
...
String _parserFuncList$0ListReward(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

String _parserFuncList$0ListMoney(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

int _parserFuncList$0ListTime(dynamic v) => JsonValueTransformer.parse<int>(v);

String _parserFuncList$0ListRebate(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

String _parserFuncList$0ListModel(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

String _parserFuncList$0ListWay(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

List<int> _parserFuncList$0ListNum(List<dynamic> v) =>
    v.map((o) => JsonValueTransformer.parse<int>(o)).toList();

List<dynamic> _parserFuncList$0ListFa$0ListResult(List<dynamic> v) =>
    v.map((o) => _innerValueParser(o)).toList();

int _parserFuncList$0ListFa$0ListStatus(dynamic v) =>
    JsonValueTransformer.parse<int>(v);

int _parserFuncList$0ListFa$0ListDay(dynamic v) =>
    JsonValueTransformer.parse<int>(v);

String _parserFuncList$0ListFa$0ListTeamAName(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

String _parserFuncList$0ListFa$0ListTeamBName(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

List<List<dynamic>> _parserFuncList$0ListFa$0ListWant(List<dynamic> v) =>
    v.map((o) => _innerValueParser(o)).toList();

String _parserFuncList$0ListFa$0ListLenName(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

List<OutputList$0ListFa$0ListBean> _parserFuncList$0ListFa(List<dynamic> v) =>
    v.map((o) => _innerValueParser(o)).toList();

List<List<String>> _parserFuncList$0ListThreeNumber(List<dynamic> v) =>
    v.map((o) => _innerValueParser(o)).toList();

String _parserFuncList$0ListThreeB(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

String _parserFuncList$0ListThreeQs(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

List<List<String>> _parserFuncList$0ListFiveNumber(List<dynamic> v) =>
    v.map((o) => _innerValueParser(o)).toList();

String _parserFuncList$0ListFiveB(dynamic v) =>
    JsonValueTransformer.parse<String>(v);

String _parserFuncList$0ListFiveQs(dynamic v) =>
    JsonValueTransformer.parse<String>(v);
...
List<String> _parserFuncList$0ListPrice(List<dynamic> v) =>
    v.map((o) => JsonValueTransformer.parse<String>(o)).toList();

int _parserFuncList$0ListIfg(dynamic v) => JsonValueTransformer.parse<int>(v);

String _parserFuncList$0ListName(dynamic v) =>
    JsonValueTransformer.parse<String>(v);
...
int _parserFuncList$0ListNumber(dynamic v) =>
    JsonValueTransformer.parse<int>(v);

int _parserFuncList$0ListAllmoney(dynamic v) =>
    JsonValueTransformer.parse<int>(v);

double _parserFuncList$0ListYj(dynamic v) =>
    JsonValueTransformer.parse<double>(v);

double _parserFuncList$0ListG(dynamic v) =>
    JsonValueTransformer.parse<double>(v);

int _parserFuncList$0ListT(dynamic v) => JsonValueTransformer.parse<int>(v);

List<OutputList$0ListBean> _parserFuncList(List<dynamic> v) =>
    v.map((o) => _innerValueParser(o)).toList();
